...
# they are identical across every environment in a given clone. That is why this
# file is the same five variables stage declares, with the same rules: a prod
# root that took a sixth input, or validated one of these more loosely, would be
# a prod that stage cannot vouch for.
#
